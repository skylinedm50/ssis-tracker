...
public class AdapterComentarios extends RecyclerView.Adapter<AdapterComentarios.HolderComentarios> {
    ...
    public void onBindViewHolder(@NonNull HolderComentarios holderComentarios, int i) {
        holderComentarios.txtUsuario.setText(comentarios.get(i)[0]);
        holderComentarios.txtFchActualizacion.setText(comentarios.get(i)[1]);
        holderComentarios.txtComentario.setText(comentarios.get(i)[2]);
    }
